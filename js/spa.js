...
window.productsData = {
    safety: [
        { id: 'saf-01', name_i18n: 'page.products.cat1Item1', img: 'images/helm-keselamatan.png', alt_id: 'Helm Keselamatan', desc_id: 'Helm keselamatan berkualitas tinggi yang dirancang untuk perlindungan maksimal di lingkungan kerja. Material kuat, tahan benturan, dengan suspensi yang nyaman.', desc_en: 'High-quality safety helmet designed for maximum protection in the work environment. Strong, impact-resistant material with a comfortable suspension.' },
        { id: 'saf-02', name_i18n: 'page.products.cat1Item2', img: 'images/rompi-pengaman.png', alt_id: 'Rompi Pengaman', desc_id: 'Rompi dengan visibilitas tinggi, dilengkapi dengan strip reflektif untuk keamanan kerja di malam hari atau kondisi minim cahaya.', desc_en: 'High-visibility vest equipped with reflective strips for work safety at night or in low-light conditions.' },
        { id: 'saf-03', name_i18n: 'page.products.cat1Item3', img: 'images/sarung-tangan.png', alt_id: 'Sarung Tangan', desc_id: 'Sarung tangan pelindung multi-fungsi, memberikan cengkeraman kuat dan proteksi terhadap goresan dan bahan kimia ringan.', desc_en: 'Multi-functional protective gloves, providing a strong grip and protection against scratches and light chemicals.' },
        { id: 'saf-04', name_i18n: 'page.products.cat1Item4', img: 'images/sepatu-kerja.png', alt_id: 'Sepatu Kerja', desc_id: 'Sepatu kerja dengan ujung baja dan sol anti-slip, memberikan perlindungan dan kenyamanan sepanjang hari kerja.', desc_en: 'Work shoes with steel toes and anti-slip soles, providing protection and comfort throughout the workday.' }
    ],
    agriculture: [
        { id: 'agr-01', name_i18n: 'page.products.cat2Item1', img: 'images/bibit-berkualitas.png', alt_id: 'Bibit Berkualitas', desc_id: 'Bibit tanaman unggul yang telah melalui proses seleksi ketat untuk menjamin hasil panen yang optimal dan berkualitas.', desc_en: 'Superior plant seeds that have undergone a rigorous selection process to ensure optimal and high-quality yields.' },
        { id: 'agr-02', name_i18n: 'page.products.cat2Item2', img: 'images/pupuk-organik.png', alt_id: 'Pupuk Organik', desc_id: 'Pupuk organik murni yang menyuburkan tanah dan menutrisi tanaman secara alami, ramah lingkungan dan berkelanjutan.', desc_en: 'Pure organic fertilizer that naturally enriches the soil and nourishes plants, environmentally friendly and sustainable.' },
        { id: 'agr-03', name_i18n: 'page.products.cat2Item3', img: 'images/pestisida.png', alt_id: 'Pestisida', desc_id: 'Pestisida efektif untuk mengendalikan hama dan penyakit tanaman, dengan formula yang aman bagi lingkungan jika digunakan sesuai anjuran.', desc_en: 'Effective pesticide for controlling plant pests and diseases, with an environmentally safe formula when used as directed.' },
        { id: 'agr-04', name_i18n: 'page.products.cat2Item4', img: 'images/peralatan-mesin.png', alt_id: 'Peralatan Mesin', desc_id: 'Berbagai macam peralatan mesin pertanian modern untuk meningkatkan efisiensi dan kecepatan dalam proses pengolahan lahan.', desc_en: 'A wide range of agricultural machinery to increase efficiency and speed in land processing.' }
    ],
    industrial: [
        { id: 'ind-01', name_i18n: 'page.products.cat3Item1', img: 'images/pompa-industri.png', alt_id: 'Pompa Industri', desc_id: 'Pompa industri heavy-duty dengan daya tahan tinggi, cocok untuk berbagai kebutuhan transfer cairan di lingkungan pabrik.', desc_en: 'Heavy-duty industrial pump with high durability, suitable for various fluid transfer needs in a factory environment.' },
        { id: 'ind-02', name_i18n: 'page.products.cat3Item2', img: 'images/motor-listrik.png', alt_id: 'Motor Listrik', desc_id: 'Motor listrik efisiensi tinggi yang memberikan tenaga handal untuk berbagai aplikasi mesin industri.', desc_en: 'High-efficiency electric motor that provides reliable power for various industrial machine applications.' },
        { id: 'ind-03', name_i18n: 'page.products.cat3Item3', img: 'images/pipa-and-fitting.png', alt_id: 'Pipa & Fitting', desc_id: 'Sistem perpipaan dan fitting lengkap dengan material berkualitas, tahan korosi, dan tekanan tinggi.', desc_en: 'Complete piping and fitting system with quality materials, resistant to corrosion and high pressure.' },
        { id: 'ind-04', name_i18n: 'page.products.cat3Item4', img: 'images/sistem-otomasi.png', alt_id: 'Sistem Otomasi', desc_id: 'Solusi sistem otomasi industri untuk meningkatkan produktivitas, presisi, dan mengurangi biaya operasional.', desc_en: 'Industrial automation system solutions to increase productivity, precision, and reduce operational costs.' }
    ]
};
